...
class RestockOrder extends Model
{
    ...
    {
        return $this->morphMany(RestockOrderItem::class, 'sourceable')->with(['purchase_order_item' => function($query) {
            $query->with(['order_item']);
        }]);
    }
    ...
    public function status() {
        return $this->hasOne(RestockOrderStatus::class, 'id', 'restock_order_statuses_id');
    }

    public function getCloseAttribute() {
        return in_array($this->restock_order_statuses_id, [2,3]);
    }
}
