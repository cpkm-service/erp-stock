...
class InquiryOrder extends Model
{
    ...
    {
        return $this->morphToMany(OrderItem::class, 'order_itemable')->with(['product' => function($query){
    ...
    public function status() {
        return $this->hasOne(InquiryOrderStatus::class, 'id', 'inquiry_order_statuses_id');
    }

    public function getCloseAttribute() {
        return in_array($this->inquiry_order_statuses_id, [2,3]) || $this->purchase_order;
    }
}
