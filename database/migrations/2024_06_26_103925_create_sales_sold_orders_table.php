...
return new class extends Migration
{
    ...
    {
        Schema::dropIfExists('sales_sold_orders');
        Schema::create('sales_sold_orders', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedBigInteger('sales_sold_order_statuses_id')->default(1)->comment('狀態');
            $table->timestamps();
            $table->comment('銷貨憑單');
        });
    }
