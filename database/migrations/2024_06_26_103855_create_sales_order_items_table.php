...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('sales_order_items', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('quote_count')->default(0)->comment('報價數量');
            ...
            $table->unsignedBigInteger('sales_quote_order_items_id')->nullable()->comment('報價單項目編號');
            $table->timestamps();
            $table->comment('訂購憑單項目');
        });
    }
