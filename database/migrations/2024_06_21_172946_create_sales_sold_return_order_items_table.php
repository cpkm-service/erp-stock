...
return new class extends Migration
{
    ...
    {
        Schema::create('sales_sold_return_order_items', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedBigInteger('sales_sold_order_items_id')->nullable()->comment('銷貨單項目編號');
            $table->timestamps();
            $table->comment('銷貨單項目');
        });
    }
    ...
    {
        Schema::dropIfExists('sales_sold_return_order_items');
    }
};
