...
<div class="block block-rounded">
    <div class="block-header block-header-default">
        ...
        <a href="{{ route('backend.restock_orders.create') }}" class="btn btn-primary create">{{ __('create') }}</a>
    </div>
    <div class="block-content block-content-full">
...
<script type="text/javascript">
    var url = "{{route('backend.restock_orders.index',[],false)}}";
    var search = makeDataTable(
        ...
        [
            ...
            },
            {
                ...
                title: "{{__('backend.restock_orders.date')}}"
            },
            {
                data: "no",
                className: "text-md-center",
                title: "{{__('backend.restock_orders.no')}}"
            },
            {
                data: "factory.name",
                className: "text-md-center",
                title: "{{__('backend.restock_orders.factory_id')}}"
            },
            {
                data: "name",
                className: "text-md-center",
                title: "{{__('backend.restock_orders.name')}}"
            },
            {
                data: "staff.name",
                className: "text-md-center",
                title: "{{__('backend.restock_orders.staff_id')}}"
            },
            {
                data: "department.name",
                className: "text-md-center",
                title: "{{__('backend.restock_orders.departments_id')}}"
            },
            {
                data: "status.name",
                className: "text-md-center",
                title: "{{__('backend.restock_orders.restock_order_statuses_id')}}",
