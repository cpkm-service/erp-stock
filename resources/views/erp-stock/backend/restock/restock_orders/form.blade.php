                                                ...
                                                <tr class="product_item template_item ui-sortable-handle">
                                                    ...
                                                    <td class="text-center align-top">
                                                        <x-backend.select 
                                                            ...
                                                            :value="($item->purchase_order_item?->order_item->products_id??$item['products_id'])" />
                                                    </td>
                                                    <td class="text-center align-top">
                                                        <x-backend.input 
                                                            ...
                                                            :value="($item->purchase_order_item?->order_item->name??$item['name'])" />
                                                    </td>
                                                    <td class="text-center align-top">
                                                        <x-backend.input 
                                                                ...
                                                                :value="($item->purchase_order_item?->order_item->standard??$item['standard'])" />
                                                    </td>
                                                    <td class="text-center align-top">
                                                        <x-backend.input 
                                                            ...
                                                            :value="($item->purchase_order_item?->order_item->size??$item['size'])" />
                                                    </td>
                                                    <td class="text-center align-top">
                                                        <x-backend.input 
                                                            ...
                                                            :value="($item->purchase_order_item?->order_item->unit??$item['unit'])" />
                                                    </td>
                                                    <td class="text-center align-top">
                                                        <x-backend.input 
                                                    ...
                                                    <td class="text-center align-top">
                                                        <span id="product_stock_{{($key +1)}}">
                                                            {{number_format($item->purchase_order_item?->order_item->stock)}}
                                                        </span>
                                                    </td>
                                                    <td class="text-center align-top">
                                                        <x-backend.input 
                                                                ...
                                                                :value="($item->purchase_order_item?->order_item->unit_amount??$item['unit_amount'])" />
                                                    </td>
                                                    <td class="text-center align-top">
                                                        <x-backend.input 
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#transfer-record-{{$item->id}}" aria-expanded="false" aria-controls="transfer-record-{{$item->id}}">
                                        {{implode("-", array_filter([$item->purchase_order_item?->order_item->name,$item->purchase_order_item?->order_item->standard,$item->purchase_order_item?->order_item->size]))}}
                                    </button>
                                </h2>
        ...
        <tbody>
            <tr class="product_item template_item ui-sortable-handle" id="product_template">
                <td class="text-center align-top">
                    $i
                    @if(!($show??false))
                    <input type="hidden" name="items[$i][purchase_order_items_id]">
                    @if(!request()->sourceable_type == \App\Models\PurchaseOrder::class)
                    <input type="hidden" name="items[$i][acceptance_order_items_id]">
                    @endif
                    @else
...
<script>
    var url = "{{route('backend.restock_orders.index')}}";
    ...
    $(`select[name="sourceable_id"]`).change(function(){
        ...
        if(id) {
            sendApi(`${url}`,"GET",{
                ...
                @else
                let order = result.data.sourceable.sourceable;
                @endif
                if(order.file) {
                    let file = order.file;
                    let name = file.split('/');
                ...
                result.data.items.map((item, key) => {
                    ...
                    setTimeout(() => {
                        @if(request()->sourceable_type == \App\Models\PurchaseOrder::class)
                        let order_item = item.order_item;
                        let purchase_order_item = item;
                        @else
                        let order_item = item.sourceable.sourceable.order_item;
                        let purchase_order_item = item.sourceable.sourceable;
                        @endif
                        ...
                        $(`input[name="items[${i}][purchase_order_items_id]"]`).val(purchase_order_item.id);
