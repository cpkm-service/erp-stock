    ...
    <div class="block-content block-content-full">
        <form name="search">
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <x-backend.select 
                        :children="($fields['restock_order_statuses_id']['children']??[])" 
                        :options="$fields['restock_order_statuses_id']['options']" 
                        :text="$fields['restock_order_statuses_id']['text']" 
                        :name="$fields['restock_order_statuses_id']['name']" 
                        :placeholder="$fields['restock_order_statuses_id']['placeholder']"
                        :required="false"
                        :disabled="false"
                        :multiple="false"
                        value="" />
...
<div class="block block-rounded">
    <div class="block-header block-header-default">
        ...
        <a href="{{ route('backend.restock_return_orders.create') }}" class="btn btn-primary create">{{ __('create') }}</a>
    </div>
    <div class="block-content block-content-full">
...
<script type="text/javascript">
    var url = "{{route('backend.restock_return_orders.index',[],false)}}";
    var search = makeDataTable(
        ...
        [
            ...
            },
            {
                ...
                title: "{{__('backend.restock_return_orders.date')}}"
            },
            {
                data: "no",
                className: "text-md-center",
                title: "{{__('backend.restock_return_orders.no')}}"
            },
            {
                data: "factory.name",
                className: "text-md-center",
                title: "{{__('backend.restock_return_orders.factory_id')}}"
            },
            {
                data: "name",
                className: "text-md-center",
                title: "{{__('backend.restock_return_orders.name')}}"
            },
            {
                data: "staff.name",
                className: "text-md-center",
                title: "{{__('backend.restock_return_orders.staff_id')}}"
            },
            {
                data: "department.name",
                className: "text-md-center",
                title: "{{__('backend.restock_return_orders.departments_id')}}"
            },
            {
                data: "status.name",
                className: "text-md-center",
                title: "{{__('backend.restock_return_orders.restock_return_order_statuses_id')}}",
