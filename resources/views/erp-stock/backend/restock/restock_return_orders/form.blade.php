                    ...
                    <div class="tab-pane active" id="btabs-static-home" role="tabpanel" aria-labelledby="btabs-alt-static-home-tab">
                        <form action="{{$form['action']}}" method="POST" name="{{$form['name']}}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-3">
                                    <x-backend.select 
                                        ...
                                        :readonly="$form['fields']['sourceable_type']['readonly']??false"
                            ...
                            <div class="row">
                                <div class="col-12 col-md-3">
                                    <x-backend.input
                                        :tag="$form['fields']['invoice']['tag']" 
                                        :type="$form['fields']['invoice']['type']" 
                                        :text="$form['fields']['invoice']['text']" 
                                        :name="$form['fields']['invoice']['name']" 
                                        :placeholder="$form['fields']['invoice']['placeholder']"
                                        :required="($form['fields']['invoice']['required']??false)"
                                        :disabled="($form['fields']['invoice']['disabled']??false)"
                                        :value="($form['fields']['invoice']['value']??'')" />
                                </div>
                                <div class="col-12 col-md-3">
                                    <x-backend.input
                                        :tag="$form['fields']['summons']['tag']" 
                                        :type="$form['fields']['summons']['type']" 
                                        :text="$form['fields']['summons']['text']" 
                                        :name="$form['fields']['summons']['name']" 
                                        :placeholder="$form['fields']['summons']['placeholder']"
                                        :required="($form['fields']['summons']['required']??false)"
                                        :disabled="($form['fields']['summons']['disabled']??false)"
                                        :value="($form['fields']['summons']['value']??'')" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <button class="btn @if($detail->restock_order_statuses_id == 1) btn-warning @elseif($detail->restock_order_statuses_id == 2) btn-primary @else btn-danger @endif" type="button" id="close" data-id="{{$detail->id}}">{{$detail->status->name}}</button>
                                </div>
                            </div>
                            @endif
                            <div class="row">
                                        ...
                                        <table class="table table-striped table-vcenter">
                                            ...
                                            <tbody id="product_area" data-name="products">
                                                ...
                                                @if(request()->sourceable_type == \App\Models\PurchaseOrder::class)
                                                    ...
                                                    @continue
                                                    @endif
                                                @elseif(request()->sourceable_type == \App\Models\AcceptanceOrder::class)
                                                    @if(!$item->check)
                                                    @continue
                                                    @endif
                                                @endif
                                                <tr class="product_item template_item ui-sortable-handle">
                                                    <td class="text-center align-top">
                                                        {{( $key + 1 )}}
                                                        <input type="hidden" name="items[{{($key+1)}}][purchase_order_items_id]" value="{{$item['id']}}">
                                                    ...
                                                    <td class="text-center align-top">
                                                        <x-backend.select 
                                                            ...
                                                            :readonly="($form['fields']['items']['products_id']['readonly']??false)"
                                                            :multiple="($form['fields']['items']['products_id']['multiple']??false)"
                                                            :value="($item->restock_order_item?->purchase_order_item?->order_item->products_id??$item['products_id'])" />
                                                    </td>
                                                    <td class="text-center align-top">
                                                        <x-backend.input 
                                                            ...
                                                            :value="($item->restock_order_item?->purchase_order_item?->order_item->name??$item['name'])" />
                                                    </td>
                                                    <td class="text-center align-top">
                                                        <x-backend.input 
                                                                ...
                                                                :value="($item->restock_order_item?->purchase_order_item?->order_item->standard??$item['standard'])" />
                                                    </td>
                                                    <td class="text-center align-top">
                                                        <x-backend.input 
                                                            ...
                                                            :value="($item->restock_order_item?->purchase_order_item?->order_item->size??$item['size'])" />
                                                    </td>
                                                    <td class="text-center align-top">
                                                        <x-backend.input 
                                                            ...
                                                            :value="($item->restock_order_item?->purchase_order_item?->order_item->unit??$item['unit'])" />
                                                    </td>
                                                    <td class="text-center align-top">
                                                        <x-backend.input 
                                                            ...
                                                            :value="(request()->sourceable_type == \App\Models\AcceptanceOrder::class)?$item->receive_material_order_item->count??0:($item['count']??'')" />
                                                    </td>
                                                    <td class="text-center align-top">
                                                        <span id="product_stock_{{($key +1)}}">
                                                            {{number_format($item->restock_order_item?->purchase_order_item?->order_item->stock)}}
                                                        </span>
                                                    </td>
                                                    <td class="text-center align-top">
                                                        <x-backend.input 
                                                                ...
                                                                :value="($item->restock_order_item?->purchase_order_item?->order_item->unit_amount??$item['unit_amount'])" />
                                                    </td>
                                                    <td class="text-center align-top">
                                                        <x-backend.input 
                                                    ...
                                                    <td class="text-center align-top">
                                                        <x-backend.input-date
                                                            ...
                                                            :value="($item->purchase_order_item->order_item->need_date??$item['need_date'])" />
                                                    </td>
                                                    <td class="text-center align-top">
                                                        <x-backend.input 
                                                            ...
                                                            :value="($item->purchase_order_item->order_item->description??$item['description'])" />
                                                    </td>
                                                    <td class="text-center align-top">
                                                        <x-backend.input 
                                                    ...
                                                    <td class="text-center align-top">
                                                        <x-backend.input
                                                            ...
                                                            :value="($item->purchase_order_item->order_item->file??$item['file'])" />
                                                    </td>
                                                    <td class="text-center align-top">
                                                        <input type="checkbox" id="product_test_{{($key +1)}}" disabled @if($item->purchase_order_item->order_item->check??$item['check']) checked @endif>
                                                    </td>
                                                    <td class="text-center align-top">
                                                        <x-backend.input 
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#transfer-record-{{$item->id}}" aria-expanded="false" aria-controls="transfer-record-{{$item->id}}">
                                        {{implode("-", array_filter([$item->restock_order_item?->purchase_order_item?->order_item->name,$item->restock_order_item?->purchase_order_item?->order_item->standard,$item->restock_order_item?->purchase_order_item?->order_item->size]))}}
                                    </button>
                                </h2>
                                                ...
                                                <table class="table table-bordered w-100">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="text-center">進退序</th>
                                                            <th class="text-center">已退數量</th>
                                                            <th class="text-center">未退數量</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                    </tbody>
        ...
        <tbody>
            <tr class="product_item template_item ui-sortable-handle" id="product_template">
                <td class="text-center align-top">
                    $i
                    @if(!($show??false))
                    <input type="hidden" name="items[$i][restock_order_items_id]">
                    @else
...
<script>
    var url = "{{route('backend.restock_return_orders.index')}}";
    ...
    $(`select[name="factory_contact_id"]`).change(function() {
        ...
        if(customer_contacts_id) {
            ...
            if(contact) {
                $('input[name="factory_phone"]').val(contact.mobile);
    ...
    $(`select[name="sourceable_id"]`).change(function(){
        ...
        if(id) {
            sendApi(`${url}`,"GET",{
                ...
                $(`select[name="factory_id"]`).val(order.factory_id).trigger('change');
                $(`input[name="name"]`).val(order.name);
                $(`input[name="invoice"]`).val(order.invoice);
                $(`textarea[name="remark"]`).text(order.remark)
                result.data.items.map((item, key) => {
                    let i = key + 1;
                    $('.add-template').click();
                    setTimeout(() => {
                        let order_item = item.purchase_order_item.order_item;
                        $(`select[name="items[${i}][products_id]"]`).attr('disabled', true).val(order_item.products_id).trigger('change');
                        $(`input[data-name="items[${i}][unit_amount]"]`).val(order_item.unit_amount).trigger('keyup')
                        $(`input[name="items[${i}][acceptance_order_items_id]"]`).val(item.id);
                        $(`input[data-name="items[${i}][count]"]`).val(order_item.count).trigger('keyup');
                        $(`input[name="items[${i}][unit]"]`).attr('disabled', true).val(order_item.unit);
                        $(`input[name="items[${i}][name]"]`).attr('disabled', true).val(order_item.name);
                        $(`input[name="items[${i}][standard]"]`).attr('disabled', true).val(order_item.standard);
                        $(`input[name="items[${i}][size]"]`).attr('disabled', true).val(order_item.size);
                        $(`input[name="items[${i}][need_date]"]`).val(order_item.need_date);
                        $(`input[name="items[${i}][description]"]`).val(order_item.description);
                        $(`input[name="items[${i}][remark]"]`).val(order_item.remark);
                        $(`#product_test_${i}`).prop('checked', order_item.check);
                        $(`input[name="items[${i}][restock_order_items_id]"]`).val(order_item.id);
                        $(`input[name="items[${i}][file]"]`).attr('disabled', true)
                        if(order_item.file) {
                            let name = order_item.file.split('/');
                            getFileFromURL('{{asset('storage')}}/'+order_item.file, name.pop())
                            .then(file => {
                                const dataTransfer = new DataTransfer();
                                dataTransfer.items.add(file);
    ...
    rate.calculateAmount();
    @else
        @if($detail->restock_order_statuses_id == 1)
