...
<div class="block block-rounded">
    <div class="block-header block-header-default">
        ...
        <a href="{{ route('backend.sales.order.create') }}" class="btn btn-primary create">{{ __('create') }}</a>
    </div>
...
<script type="text/javascript">
    var url = "{{route('backend.sales.order.index',[],false)}}";
    var search = makeDataTable(
        ...
        [
            ...
            },
            {
                ...
                title: "{{__('erp-stock::backend.sales_orders.date')}}"
            },
            {
                data: "no",
                className: "text-md-center",
                title: "{{__('erp-stock::backend.sales_orders.no')}}"
            },
            {
                data: "staff.name",
                className: "text-md-center",
                title: "{{__('erp-stock::backend.sales_orders.staff_id')}}"
            },
            {
                data: "department.name",
                className: "text-md-center",
                title: "{{__('erp-stock::backend.sales_orders.departments_id')}}"
            },
            {
                data: "customer.name",
                className: "text-md-center",
                title: "{{__('erp-stock::backend.sales_orders.customers_id')}}"
            },
            {
                data: "project.name",
                className: "text-md-center",
                title: "{{__('erp-stock::backend.sales_orders.name')}}"
            },
            {
                data: "status.name",
                className: "text-md-center",
                title: "{{__('erp-stock::backend.sales_orders.sales_order_statuses_id')}}",
