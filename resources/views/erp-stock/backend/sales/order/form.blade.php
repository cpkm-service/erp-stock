                        ...
                        <form action="{{$form['action']}}" method="POST" name="{{$form['name']}}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <a href="{{route('backend.sales.sold_order.create', ['sourceable_type' => \App\Models\SalesOrder::class, 'sourceable_id' => $detail->id])}}" class="btn btn-success">轉銷貨單</a>
                                    @else
                                        @if($detail->purchase_order)
                                        <a href="{{route('backend.purchase_orders.show', ['purchase_order' => $detail->purchase_order->id])}}" class="btn btn-info" target="_blank">銷貨單</a>
                                        @endif
                                    @endif
                                </div>
                            </div>
                                            ...
                                            <tbody id="product_area" data-name="products">
                                                ...
                                                <tr class="product_item template_item ui-sortable-handle">
                                                    <td class="text-center align-top">
                                                        {{( $key + 1 )}}
                                                        <input type="hidden" name="items[{{($key+1)}}][sales_order_items_id]" value="{{$item['sales_order_items_id']}}">
                                                    ...
                                                    <td class="text-center align-top">
                                                        <x-backend.select 
                                                            ...
                                                            :value="($item->sales_order_item->products_id??'')" />
                                                        <div class="d-none">
                                                            <x-backend.input 
                                                    ...
                                                    <td class="text-center align-top">
                                                        <x-backend.input 
                                                            ...
                                                            :value="($item->sales_order_item->product_name??'')" />
                                                    </td>
                                                    <td class="text-center align-top">
                                                        <x-backend.input 
                                                                ...
                                                                :value="($item->sales_order_item->product_standard??'')" />
                                                    </td>
                                                    <td class="text-center align-top">
                                                        <x-backend.input 
                                                            ...
                                                            :value="($item->sales_order_item->size??'')" />
                                                    </td>
                                                    @if($show??false)
                                                    <td class="text-center align-top">
                                                        
                                                        <a  class="btn btn-sm btn-success makeNo" href="{{route('backend.sales.order_item_standard.create',['item' => $item['id']])}}" target="_blank">
                                                            訂購規格表
                                                        </a>
                                                    </td>
                                                    @endif
                                                    ...
                                                    <td class="text-center align-top">
                                                        <x-backend.input 
                                                            ...
                                                            :value="($item->sales_order_item->unit??'')" />
                                                    </td>
                                                    <td class="text-center align-top">
                                                        <x-backend.input 
                                                                ...
                                                                :value="($item->sales_order_item->unit_amount??'')" />
                                                    </td>
                                                    <td class="text-center align-top">
                                                        <x-backend.input 
                                                    ...
                                                    <td class="text-center align-top">
                                                        <x-backend.input 
                                                            ...
                                                            :value="($item->sales_order_item->description??'')" />
                                                    </td>
                                                    <td class="text-center align-top">
                                                        <x-backend.input 
                                                    ...
                                                    <td class="text-center align-top">
                                                        <x-backend.input
                                                            ...
                                                            :value="($item->sales_order_item->file??'')" />
                                                    </td>
                                                    <td class="text-center align-top">
                                                    @if(!($show??false))
                        ...
                        <div class="accordion" id="transfer-record-list">
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#transfer-record-{{$item->sales_order_item->id}}" aria-expanded="false" aria-controls="transfer-record-{{$item->id}}">
                                        {{implode("-", array_filter([$item->sales_order_item->name,$item->sales_order_item->standard,$item->sales_order_item->size]))}}
                                    </button>
                                </h2>
                                <div id="transfer-record-{{$item->sales_order_item->id}}" class="accordion-collapse collapse" data-bs-parent="#transfer-record-list">
                                                ...
                                                <table class="table table-bordered w-100">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="text-center">{{__('backend.sales_sold_orders.no')}}</th>
                                                            <th class="text-center">銷貨序</th>
                                                            <th class="text-center">{{__('backend.sales_sold_orders.sales_sold_order_items.*.count')}}</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th class="text-center">{{($item->sales_order_item->product->product_serial)}}</th>
                                                            <th class="text-center">{{($item->sales_order_item->name)}}</th>
                                                            <th class="text-center">{{($item->sales_order_item->standard)}}</th>
                                                            <th class="text-center">{{($item->sales_order_item->size)}}</th>
                                                            <th class="text-center">{{number_format($item->count)}}</th>
                                                            <th class="text-center">{{($item->sales_order_item->product->unit)}}</th>
                                                            <th class="text-center">{{($sales_sold_order_item->sourceable->first()?->no)}}</th>
                                                            <th class="text-center">{{($sales_sold_order_item->sourceable->first()?->id)}}</th>
        ...
        <tbody>
            <tr class="product_item template_item ui-sortable-handle" id="product_template">
                <td class="text-center align-top">
                    $i
                    @if(!($show??false))
                    <input type="hidden" name="items[$i][sales_order_items_id]">
                    @else
...
<script>
    ...
    $(`select[name="sourceable_type"]`).change(function(){
        if($(this).val() == "App\\Models\\SalesQuoteOrder") {
            sendApi(`${url}`,"GET",{
            ...
            sendApi(`${url}`,"GET",{
                ...
                result.data.items.map((item, key) => {
                    ...
                    setTimeout(() => {
                        ...
                        $(`input[data-name="items[${i}][count]"]`).val(item.quote_count).trigger('keyup');
                        $(`[id="number-items[${i}][unit_amount]"]`).val(item.unit_amount).attr('disabled', true).trigger('keyup');
                        $(`input[name="items[${i}][unit]"]`).attr('disabled', true).val(item.unit);
                        $(`input[name="items[${i}][description]"]`).attr('disabled', true).val(item.description);
                        $(`input[name="items[${i}][remark]"]`).attr('disabled', true).val(item.remark);
                        $(`input[name="items[${i}][sales_order_items_id]"]`).val(item.id);
